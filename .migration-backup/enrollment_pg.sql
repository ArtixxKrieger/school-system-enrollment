...
DROP TABLE IF EXISTS course_enrollment_schedule CASCADE;
CREATE TABLE course_enrollment_schedule (
  id integer NOT NULL,
  course_id integer NOT NULL,
  enrollment_start_date timestamp NOT NULL,
  enrollment_end_date timestamp NOT NULL,
...
CREATE TABLE curriculum (
  ...
  is_offered smallint NOT NULL DEFAULT 0,
  is_active smallint DEFAULT 1,
  created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
DROP TABLE IF EXISTS enrollees CASCADE;
...
CREATE TABLE enrollment_settings (
  ...
  auto_close_accounts varchar(100) DEFAULT 'never',
  strict_enrollment_windows smallint DEFAULT 0,
  auto_progression smallint DEFAULT 1,
  system_close_date timestamp DEFAULT NULL,
  created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE students (
  ...
  finance_status varchar(100) DEFAULT 'fully_paid',
  finance_total decimal(10,2) DEFAULT 0.00,
  finance_paid decimal(10,2) DEFAULT 0.00,
  student_type varchar(100) DEFAULT 'regular',
  ...
  flag_group varchar(100) DEFAULT NULL,
  is_account_active smallint DEFAULT 1,
  import_semester smallint DEFAULT NULL,
  progression_status varchar(100) DEFAULT 'enrolled'
);
...
DROP TABLE IF EXISTS student_curriculum_assignments CASCADE;
CREATE TABLE student_curriculum_assignments (
  id integer NOT NULL,
  student_id integer NOT NULL,
  curriculum_id integer NOT NULL,
  source_year_level integer NOT NULL,
  source_semester integer NOT NULL,
...
DROP TABLE IF EXISTS student_enrolled_subjects CASCADE;
...
DROP TABLE IF EXISTS student_records_archive CASCADE;
CREATE TABLE student_records_archive (
  ...
  year_level integer DEFAULT 1,
  current_semester smallint DEFAULT NULL,
  current_academic_year varchar(20) DEFAULT NULL,
...
CREATE TABLE subject_offerings (
  ...
  offered_by integer DEFAULT NULL,
...
CREATE TABLE users (
  ...
  session_version integer DEFAULT NULL,
  created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE UNIQUE INDEX IF NOT EXISTS course_code ON courses (course_code);

--
-- Indexes for table course_enrollment_schedule
--
ALTER TABLE course_enrollment_schedule ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS unique_course ON course_enrollment_schedule (course_id);
CREATE INDEX IF NOT EXISTS idx_ces_course ON course_enrollment_schedule (course_id);

--
-- Indexes for table curriculum
--
ALTER TABLE curriculum ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS unique_subject ON curriculum (course_id,subject_code,year_level,semester);
CREATE INDEX IF NOT EXISTS professor_id ON curriculum (professor_id);
CREATE INDEX IF NOT EXISTS idx_curriculum_course ON curriculum (course_id);

--
-- Indexes for table enrollees
--
ALTER TABLE enrollees ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS pre_reg_number ON enrollees (pre_reg_number);
CREATE UNIQUE INDEX IF NOT EXISTS email ON enrollees (email);
CREATE INDEX IF NOT EXISTS approved_by ON enrollees (approved_by);
CREATE INDEX IF NOT EXISTS idx_enrollees_status ON enrollees (status);
CREATE INDEX IF NOT EXISTS idx_enrollees_course ON enrollees (course_id);
CREATE INDEX IF NOT EXISTS idx_enrollees_email ON enrollees (email);

--
-- Indexes for table enrollment_settings
--
ALTER TABLE enrollment_settings ADD PRIMARY KEY (id);

--
-- Indexes for table permission_modules
--
ALTER TABLE permission_modules ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS module_slug ON permission_modules (module_slug);

--
-- Indexes for table roles
--
ALTER TABLE roles ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS name ON roles (name);

--
-- Indexes for table role_permissions
--
ALTER TABLE role_permissions ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS unique_role_permission ON role_permissions (role_id,permission_module_slug,action);

--
-- Indexes for table students
--
ALTER TABLE students ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS student_id ON students (student_id);
CREATE UNIQUE INDEX IF NOT EXISTS email ON students (email);
CREATE UNIQUE INDEX IF NOT EXISTS pre_reg_number ON students (pre_reg_number);
...
--
ALTER TABLE student_curriculum_assignments ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS uniq_student_curriculum ON student_curriculum_assignments (student_id,curriculum_id);
CREATE INDEX IF NOT EXISTS curriculum_id ON student_curriculum_assignments (curriculum_id);
CREATE INDEX IF NOT EXISTS assigned_by ON student_curriculum_assignments (assigned_by);

--
-- Indexes for table student_enrolled_subjects
--
ALTER TABLE student_enrolled_subjects ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS uniq_student_enrolled_subject ON student_enrolled_subjects (student_id,curriculum_id);
CREATE INDEX IF NOT EXISTS idx_student_enrolled_student ON student_enrolled_subjects (student_id);
CREATE INDEX IF NOT EXISTS idx_student_enrolled_curriculum ON student_enrolled_subjects (curriculum_id);
CREATE INDEX IF NOT EXISTS idx_student_enrolled_offering ON student_enrolled_subjects (offering_id);

--
-- Indexes for table student_records_archive
--
ALTER TABLE student_records_archive ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS uniq_student_records_archive ON student_records_archive (student_pk);
CREATE INDEX IF NOT EXISTS idx_records_archive_reason ON student_records_archive (archive_reason);
CREATE INDEX IF NOT EXISTS idx_records_archive_archived_at ON student_records_archive (archived_at);
CREATE INDEX IF NOT EXISTS course_id ON student_records_archive (course_id);

--
-- Indexes for table subject_offerings
--
ALTER TABLE subject_offerings ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS uniq_subject_offering ON subject_offerings (curriculum_id,course_id,year_level,semester);
CREATE INDEX IF NOT EXISTS idx_subject_offerings_course_setup ON subject_offerings (course_id,year_level,semester);
CREATE INDEX IF NOT EXISTS idx_subject_offerings_curriculum ON subject_offerings (curriculum_id);
...
CREATE INDEX IF NOT EXISTS fk_users_role_id ON users (role_id);
...
--
--  for table course_enrollment_schedule
--
...
--
--  for table student_curriculum_assignments
--


--
--  for table student_enrolled_subjects
--


--
--  for table student_records_archive
--


--
--  for table subject_offerings
--
...
--
ALTER TABLE course_enrollment_schedule ADD CONSTRAINT course_enrollment_schedule_ibfk_1 FOREIGN KEY (course_id) REFERENCES courses (id) ON DELETE CASCADE;

--
-- Constraints for table curriculum
--
ALTER TABLE curriculum ADD CONSTRAINT curriculum_ibfk_1 FOREIGN KEY (course_id) REFERENCES courses (id) ON DELETE CASCADE;
ALTER TABLE curriculum ADD CONSTRAINT curriculum_ibfk_2 FOREIGN KEY (professor_id) REFERENCES users (id) ON DELETE SET NULL;

--
-- Constraints for table enrollees
--
ALTER TABLE enrollees ADD CONSTRAINT enrollees_ibfk_1 FOREIGN KEY (course_id) REFERENCES courses (id) ON DELETE SET NULL;
ALTER TABLE enrollees ADD CONSTRAINT enrollees_ibfk_2 FOREIGN KEY (approved_by) REFERENCES users (id) ON DELETE SET NULL;
...
--
ALTER TABLE students ADD CONSTRAINT students_ibfk_1 FOREIGN KEY (course_id) REFERENCES courses (id);
ALTER TABLE students ADD CONSTRAINT students_ibfk_2 FOREIGN KEY (pre_reg_number) REFERENCES enrollees (pre_reg_number) ON DELETE SET NULL;

--
-- Constraints for table student_curriculum_assignments
--
ALTER TABLE student_curriculum_assignments ADD CONSTRAINT student_curriculum_assignments_ibfk_1 FOREIGN KEY (student_id) REFERENCES students (id) ON DELETE CASCADE;
ALTER TABLE student_curriculum_assignments ADD CONSTRAINT student_curriculum_assignments_ibfk_2 FOREIGN KEY (curriculum_id) REFERENCES curriculum (id) ON DELETE CASCADE;
ALTER TABLE student_curriculum_assignments ADD CONSTRAINT student_curriculum_assignments_ibfk_3 FOREIGN KEY (assigned_by) REFERENCES users (id) ON DELETE SET NULL;

--
-- Constraints for table student_records_archive
--
ALTER TABLE student_records_archive ADD CONSTRAINT student_records_archive_ibfk_1 FOREIGN KEY (course_id) REFERENCES courses (id) ON DELETE SET NULL;
