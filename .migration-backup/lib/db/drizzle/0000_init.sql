...
DO $$ BEGIN
  ALTER TABLE "permission_modules" ADD CONSTRAINT "permission_modules_module_slug_unique" UNIQUE("module_slug");
...
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "enrollees" ADD CONSTRAINT "enrollees_pre_reg_number_unique" UNIQUE("pre_reg_number");
EXCEPTION WHEN duplicate_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "enrollees" ADD CONSTRAINT "enrollees_email_unique" UNIQUE("email");
EXCEPTION WHEN duplicate_table THEN NULL; WHEN duplicate_object THEN NULL; END $$;
--> statement-breakpoint
...
"system_close_date" timestamp with time zone,
"created_at" timestamp with time zone DEFAULT now() NOT NULL,
"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "course_enrollment_schedule" ADD CONSTRAINT "course_enrollment_schedule_course_id_courses_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
